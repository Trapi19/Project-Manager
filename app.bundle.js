...
const ProjectList = ({ projects, onCreate, onSelect, onDelete, onMoveProject, onBackup, onExportCSV, onImport, theme, onToggleTheme, storagePercent }) => {
    ...
    const storageLabel = typeof storagePercent === 'number' ? `${storagePercent}% usado` : 'OK';
    const storageClass = typeof storagePercent === 'number' && storagePercent >= 80 ? 'is-warning' : '';
    // Layout profesional: navegación lateral fija para que las acciones importantes estén siempre visibles.
    return (React.createElement("div", { className: "app-shell" }, React.createElement("aside", { className: "app-sidebar no-print", "aria-label": "Navegación principal" }, React.createElement("div", { className: "sidebar-brand" }, React.createElement("div", { className: "sidebar-logo" }, React.createElement("img", { src: UNITECNIC_LOGO_BASE64, alt: "Unitecnic" })), React.createElement("div", { className: "min-w-0" }, React.createElement("div", { className: "sidebar-title" }, "Unitecnic"), React.createElement("div", { className: "sidebar-subtitle" }, "Project Manager"))), React.createElement("button", { type: "button", onClick: onCreate, className: "sidebar-new" }, React.createElement("i", { className: "fas fa-plus" }), React.createElement("span", null, "Nuevo proyecto")), React.createElement("nav", { className: "sidebar-nav" }, React.createElement("button", { type: "button", className: "sidebar-nav-item is-active", onClick: () => window.scrollTo({ top: 0, behavior: 'smooth' }) }, React.createElement("i", { className: "fas fa-layer-group" }), React.createElement("span", null, "Proyectos"), React.createElement("b", null, nonCompletedProjects.length)), React.createElement("button", { type: "button", className: "sidebar-nav-item", onClick: () => window.location.hash = '#/alerts' }, React.createElement("i", { className: "fas fa-triangle-exclamation" }), React.createElement("span", null, "Alertas"), (executiveSummary.redProjects + executiveSummary.blockedProjects) > 0 && React.createElement("b", { className: "danger" }, executiveSummary.redProjects + executiveSummary.blockedProjects)), React.createElement("button", { type: "button", className: "sidebar-nav-item", onClick: () => window.location.hash = '#/workload' }, React.createElement("i", { className: "fas fa-users-gear" }), React.createElement("span", null, "Equipo")), React.createElement("button", { type: "button", className: "sidebar-nav-item", onClick: () => window.location.hash = '#/charts' }, React.createElement("i", { className: "fas fa-chart-pie" }), React.createElement("span", null, "Gráficos")), React.createElement("button", { type: "button", className: "sidebar-nav-item", onClick: () => setActionsOpen(true) }, React.createElement("i", { className: "fas fa-sliders" }), React.createElement("span", null, "Settings"))), React.createElement("div", { className: "sidebar-panel" }, React.createElement("div", { className: "sidebar-panel-label" }, "Estado rápido"), React.createElement("div", { className: "sidebar-metric" }, React.createElement("span", null, "En ejecución"), React.createElement("strong", null, activeProjects.length)), React.createElement("div", { className: "sidebar-metric" }, React.createElement("span", null, "En revisión"), React.createElement("strong", null, reviewProjects.length)), React.createElement("div", { className: "sidebar-metric" }, React.createElement("span", null, "Completados"), React.createElement("strong", null, completedProjects.length))), React.createElement("div", { className: "sidebar-footer" }, React.createElement("button", { type: "button", className: "sidebar-user", title: userLabel }, React.createElement("span", { className: "sidebar-avatar" }, String(userLabel || 'U').slice(0, 1).toUpperCase()), React.createElement("span", { className: "sidebar-user-text" }, React.createElement("strong", null, "Usuario"), React.createElement("small", null, userLabel))), React.createElement("div", { className: `sidebar-storage ${storageClass}` }, React.createElement("i", { className: "fas fa-database" }), React.createElement("span", null, storageLabel)), React.createElement("button", { type: "button", className: "sidebar-theme", onClick: onToggleTheme }, React.createElement("i", { className: theme === 'dark' ? "fas fa-sun" : "fas fa-moon" }), React.createElement("span", null, theme === 'dark' ? "Modo día" : "Modo noche")))), React.createElement("main", { className: "app-main max-w-7xl mx-auto p-6 md:p-10" }, React.createElement("div", { className: "flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4" }, React.createElement("div", { className: "flex items-start gap-4" }, React.createElement("div", { className: "w-14 h-14 rounded-2xl bg-white/70 border border-gray-200 shadow-sm flex items-center justify-center overflow-hidden shrink-0" }, React.createElement("img", { src: UNITECNIC_LOGO_BASE64, alt: "Unitecnic", className: "w-full h-full object-contain p-2" })), React.createElement("div", null, React.createElement("h1", { className: "text-3xl font-bold text-gray-900" }, "Dashboard Unitecnic"), React.createElement("p", { className: "text-gray-500 mt-1 flex items-center gap-2" }, React.createElement("i", { className: "fas fa-hdd text-orange-500" }), " Modo Cloud (AWS)"),
    ...
    React.createElement("div", { className: "section-tapiz section--ejecucion p-6 rounded-2xl border", "data-estado-seccion": "En Ejecuci\u00F3n", onDragOver: handleSectionDragOver, onDrop: (e) => handleSectionDrop(e, 'En Ejecución') }, React.createElement("h2", { className: "text-lg font-bold text-blue-900 mb-6 flex items-center gap-2" }, React.createElement("span", { className: "bg-blue-500 w-2 h-2 rounded-full" }), " En Ejecuci\u00F3n", React.createElement("span", { className: "ml-2 bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full text-xs" }, activeProjects.length)), activeProjects.length > 0 ? (React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" }, activeProjects.map(p => React.createElement(ProjectCard, { key: p.id, p: p, onSelect: onSelect, onDelete: onDelete, dnd: {
