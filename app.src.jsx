...
if (est !== 'Completado' && String(t?.prioridad || '').toLowerCase() === 'urgente') {
  urgentTasks += 1;
    ...
    return (React.createElement("div", { className: "app-shell" },
        React.createElement("aside", { className: "app-sidebar no-print", "aria-label": "Navegación principal" },
            React.createElement("div", { className: "sidebar-brand" },
                ...
                React.createElement("div", { className: "min-w-0" },
                    React.createElement("div", { className: "sidebar-title" }, "Unitecnic"),
                    React.createElement("div", { className: "sidebar-subtitle" }, "Project Manager"))),
            React.createElement("button", { type: "button", onClick: onCreate, className: "sidebar-new" },
                React.createElement("i", { className: "fas fa-plus" }),
                React.createElement("span", null, "Nuevo proyecto")),
            React.createElement("nav", { className: "sidebar-nav" },
                React.createElement("button", { type: "button", className: "sidebar-nav-item is-active", onClick: () => window.scrollTo({ top: 0, behavior: 'smooth' }) },
                    React.createElement("i", { className: "fas fa-layer-group" }),
                    React.createElement("span", null, "Proyectos"),
                    React.createElement("b", null, nonCompletedProjects.length)),
                React.createElement("button", { type: "button", className: "sidebar-nav-item", onClick: () => window.location.hash = '#/alerts' },
                    React.createElement("i", { className: "fas fa-triangle-exclamation" }),
                    React.createElement("span", null, "Alertas"),
                    (executiveSummary.redProjects + executiveSummary.blockedProjects) > 0 && React.createElement("b", { className: "danger" }, executiveSummary.redProjects + executiveSummary.blockedProjects)),
                React.createElement("button", { type: "button", className: "sidebar-nav-item", onClick: () => window.location.hash = '#/workload' },
                    React.createElement("i", { className: "fas fa-users-gear" }),
                    React.createElement("span", null, "Equipo")),
                React.createElement("button", { type: "button", className: "sidebar-nav-item", onClick: () => window.location.hash = '#/charts' },
                    React.createElement("i", { className: "fas fa-chart-pie" }),
                    React.createElement("span", null, "Gráficos")),
                React.createElement("button", { type: "button", className: "sidebar-nav-item", onClick: () => setActionsOpen(true) },
                    React.createElement("i", { className: "fas fa-sliders" }),
                    React.createElement("span", null, "Settings"))),
            React.createElement("div", { className: "sidebar-panel" },
                React.createElement("div", { className: "sidebar-panel-label" }, "Estado rápido"),
                React.createElement("div", { className: "sidebar-metric" },
                    React.createElement("span", null, "En ejecución"),
                    React.createElement("strong", null, activeProjects.length)),
                React.createElement("div", { className: "sidebar-metric" },
                    React.createElement("span", null, "En revisión"),
                    React.createElement("strong", null, reviewProjects.length)),
                React.createElement("div", { className: "sidebar-metric" },
                    React.createElement("span", null, "Completados"),
                    React.createElement("strong", null, completedProjects.length))),
            React.createElement("div", { className: "sidebar-footer" },
                React.createElement("button", { type: "button", className: "sidebar-user", title: userLabel },
                    React.createElement("span", { className: "sidebar-avatar" }, String(userLabel || 'U').slice(0, 1).toUpperCase()),
                    React.createElement("span", { className: "sidebar-user-text" },
                        React.createElement("strong", null, "Usuario"),
                        React.createElement("small", null, userLabel))),
                React.createElement("div", { className: `sidebar-storage ${storageClass}` },
                    React.createElement("i", { className: "fas fa-database" }),
                    React.createElement("span", null, storageLabel)),
                React.createElement("button", { type: "button", className: "sidebar-theme", onClick: onToggleTheme },
                    React.createElement("i", { className: theme === 'dark' ? "fas fa-sun" : "fas fa-moon" }),
                    React.createElement("span", null, theme === 'dark' ? "Modo día" : "Modo noche")))) ,
...
const normalized = (effectiveList || []).map(p => {
  if (!p) return p;
  if (!p.wiki) return { ...p, wiki: { content: "" } };
  if (typeof p.wiki.content !== "string") return { ...p, wiki: { ...(p.wiki || {}), content: "" } };
  return p;
});
